...
public class EscogerModelo extends ListActivity {
	@Override
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(str.equals(getResources().getString(R.string.choose_custom_model))) {
			...
			Intent intent = new Intent(EscogerModelo.this, AdministradorVerificacionArchivosActivity.class);
            startActivity(intent);
		} else {
			//load the selected internal file
			Intent intent = new Intent(EscogerModelo.this, VistaModeloAumentadoActivity.class);
            intent.putExtra("name", str+".obj");
            intent.putExtra("type", VistaModeloAumentadoActivity.TYPE_INTERNAL);
