package edu.proyint.objetovista.util;
...
public class SDCardFileUtil extends BaseFileUtil {	
	...
	/* (non-Javadoc)
	 * @see edu.proyint.objetovista.util.FileUtilInterface#getReaderFromName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.proyint.objetovista.util.FileUtilInterface#getBitmapFromName(java.lang.String)
	 */
