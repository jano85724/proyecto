 ...
 *
 */
public class AdministradorVerificacionArchivosActivity extends Activity {
	/**
	    	...
	    	case PICK_FILE:
		    	switch(resultCode) {
			    	case Activity.RESULT_OK:
			    		...
			    		if (!file.exists()) {
			    			...
			    			if(!fileName.endsWith(".obj")) {
					    		...
					    		Intent intent = new Intent(AdministradorVerificacionArchivosActivity.this, VistaModeloAumentadoActivity.class);
					            intent.putExtra("name", data.getDataString());
					            intent.putExtra("type", VistaModeloAumentadoActivity.TYPE_EXTERNAL);
			    	...
			    	case Activity.RESULT_CANCELED:
			    		...
			    		Intent intent = new Intent(AdministradorVerificacionArchivosActivity.this, EscogerModelo.class);
     ...
     *  {@link edu.proyint.objetovista.AdministradorVerificacionArchivosActivity#onActivityResult(int, int, Intent)} */
